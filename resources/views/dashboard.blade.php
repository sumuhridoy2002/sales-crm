<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl   mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- সবার জন্য: নিজের প্রোফাইল ইনফো ও KPI স্কোর -->
            ...
            <!-- শুধুমাত্র ADMIN এর জন্য: Employee Assignment & Lost Customer Dashboard -->
            @if(Auth::user()->role === 'admin')
                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <h3 class="text-xl font-bold text-red-600 mb-4">🚨 CRM: Inactive (Lost) Customers</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
                                                    ...
                                                    <form action="{{ url('/crm/customers/'.$customer->id.'/assign') }}" method="POST" class="flex items-center gap-2">
                                                        @csrf
                                                    ...
                                                    <!-- Re-engage Button -->
                                                    <form action="{{ url('/crm/customers/'.$customer->id.'/re-engage') }}" method="POST">
                                                        @csrf
